                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        for($id=0;$id<$count;++$id)
                                {
                                    ?>
                                    <img src="./admin/login/upload/<?= $res[$id]?>" height="180px" width="253px"/>
                                    <?php
                                }
                                ?>
                    </div>
                            ...
                            <div class="contact-form">
                                <div id="success"></div>
                                     <div class="control-group">
                                        <p font-color:black>Project Name -  <?php echo $data['PName'];?></p>
                                        
                                    </div>
                                    <div class="control-group">
                                        <p>Supervisior's Name -  <?php echo $data['Sname'];  ?></p>
                                    </div>
                                    <div class="control-group">
                                        <p>Date of Complition -  <?php echo $data['doc'];  ?></p>
                                    </div>
                                    <div class="control-group">
                                    <p>Estimated Cost -  <?php echo $data['ECost'];  ?></p>
                                    </div>
                                    <div class="control-group">
                                         <p>Description -</p> 
